...
function App() {
  //ссылки
  const links = [
    {name: 'Моя страница', id: 1, link: '/404'},
    {name: 'Новости', id: 2, link: '/news'},
    {name: 'Мессенджер', id: 3, link: '/'},
    {name: 'Звонки', id: 4, link: '/404'},
    {name: 'Друзья', id: 5, link: '/404'},
    {name: 'Сообщества', id: 6, link: '/404'},
    {name: 'Фотографии', id: 7, link: '/404'},
    {name: 'Музыка', id: 8, link: '/404'},
    {name: 'Видео', id: 9, link: '/404'},
    {name: 'Клипы', id: 10, link: '/404'},
    {name: 'Игры', id: 11, link: '/404'},
    {name: 'Стикеры', id: 12, link: '/404'},
    {name: 'Маркет', id: 13, link: '/404'},
    {name: 'Сервисы', id: 14, link: '/404'},
]

  //клики в header
  //!сделать еще так - что если клик был не в области
  // ! выпадающего меню то - пускай оно закроется
  let[userDropMenu, setUserDropMenu] = React.useState(false)
  const clickUser = (e) => {
    ...
    <div className="page">
      ...
      <header className="header">
        <div className="header__container">
          ...
          <div onClick={clickUser} className="header__user">
            <img src='/img/user__id1/small__photo.jpg' alt="" />
            ...
            {/* //TODO: доработать плавность, может создать setTimeout */}
            {/* //TODO: оставлю пока с косяком, потом заменить на 'user__undrop hidden' */}
            <div className={`user__drop ${!userDropMenu? 'user__undrop' : ''}`}>
              <div className="drop__top">
                  <div className="drop__info">
                    <img className="drop__photo" src="/img/user__id1/small__photo.jpg" alt="" />
                    <div className="drop__data">
                      <span>Максим Соловьев</span>
                      <p>+7 7·· ··· ·· 70</p>
                      <a href=""><img src="../img/drop__menu/inf.svg" alt="" /> Защитите свой аккаунт</a>
                    </div>
                    {/*//TODO: фоновую картику сделать - стрелочку */}
                  </div>
                  <div className="drop__vkpay">
                    <p>VK pay</p>
                    <a href="#">Открыть</a>
                    {/*//TODO: фоновую картику сделать - рубль */}
                  </div>
              </div>
              <div className="drop__bottom">
                <ul>
                  <li><img src="../img/drop__menu/1.svg" alt="" />Настройки</li>
                  <li><img src="../img/drop__menu/2.svg" alt="" />Тема:&nbsp;&nbsp;<a>Светлая</a></li>
                  <li><img src="../img/drop__menu/3.svg" alt="" />Помощь</li>
                  <li><img src="../img/drop__menu/4.svg" alt="" />Выйти</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <main className="main">
        <div className="main__container">
          ...
          {/*//!!!!!!!!!!!!!!!!!!!!!!!! Шeстеренка */}
          {/* <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g id="settings_24__Page-2" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><g id="settings_24__settings_24"><path id="settings_24__Bounds" d="M0 0h24v24H0z"></path><path d="M9.13 5.05c1.25-.72 1.47-1.47 1.62-2.22.17-.83.42-.83.83-.83h.84c.41 0 .58 0 .83.83.23.75.38 1.5 1.63 2.23 1.4.37 2.08 0 2.72-.43.7-.47.88-.29 1.18 0l.59.6c.29.29.4.4 0 1.17-.38.7-.8 1.33-.42 2.73.72 1.25 1.47 1.47 2.22 1.62.83.17.83.42.83.83v.84c0 .41 0 .58-.83.83-.75.23-1.5.38-2.23 1.63-.37 1.4 0 2.08.43 2.72.47.7.29.88 0 1.18l-.6.59c-.29.29-.4.4-1.17 0-.7-.38-1.33-.8-2.73-.42-1.25.72-1.47 1.47-1.62 2.22-.17.83-.42.83-.83.83h-.84c-.41 0-.58 0-.83-.83-.23-.75-.38-1.5-1.63-2.23-1.4-.37-2.08 0-2.72.43-.7.47-.88.29-1.18 0l-.59-.6c-.29-.29-.4-.4 0-1.17.38-.7.8-1.33.42-2.73-.72-1.25-1.47-1.47-2.22-1.62-.83-.17-.83-.42-.83-.83v-.84c0-.41 0-.58.83-.83.75-.23 1.5-.38 2.23-1.63.37-1.4 0-2.08-.43-2.72-.47-.7-.29-.88 0-1.18l.6-.59c.29-.29.4-.4 1.17 0 .7.38 1.33.8 2.73.42ZM12 16.75a4.75 4.75 0 1 0 0-9.5 4.75 4.75 0 0 0 0 9.5Z" id="settings_24__Mask" fill="currentColor"></path></g></g></svg> */}
          </nav>

         
           
          <section className="main__dynamic"> {/*//*общая динамичная область */}                 
              <Routes>
                <Route path="/" element={<Messages/>}/> {/*//?как главная */}
